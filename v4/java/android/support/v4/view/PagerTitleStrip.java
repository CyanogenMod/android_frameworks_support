...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        final int prevLeft = Math.max(stripWidth - paddingRight - prevWidth, currRight + mScaledTextSpacing);
        ...
        final int nextLeft = Math.min(paddingLeft, currLeft - mScaledTextSpacing - nextWidth);
