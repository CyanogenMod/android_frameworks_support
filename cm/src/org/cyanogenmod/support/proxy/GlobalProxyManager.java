...
public final class GlobalProxyManager {
    ...
    public void requestUserPermission() {
        ...
        String msg = "Would you like to make %1$s the default proxy for all connections ?";
        builder.setTitle("Set global proxy");
        String appName = Util.getApplicationName(mContext, mContext.getBasePackageName());
        String formattedMessage = String.format(msg, appName);
        builder.setMessage(formattedMessage)
               .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int id) {
                       Util.broadcastProxyStateChange(mContext, mContext.getBasePackageName());
                   }
               })
